# Title: Point Set Tree Path Composite Sum
# URL: https://judge.yosupo.jp/problem/point_set_tree_path_composite_sum
# Category: Tree

"""
Title: Point Set Tree Path Composite Sum

Link: https://judge.yosupo.jp/problem/point_set_tree_path_composite_sum
...
- `0 w x r` : Update $a_w$ to $x$ and then print $\left(\sum_{v=0}^{N-1} P(r, v)\right) \bmod 998244353$.
- `1 e y z r` : Update $(b_e, c_e)$ to $(y, z)$ and then print $\left(\sum_{v=0}^{N-1} P(r, v)\right) \bmod 998244353$.
...
def solve():
    ...
    # TODO: implement solution for 'point_set_tree_path_composite_sum'
    pass
