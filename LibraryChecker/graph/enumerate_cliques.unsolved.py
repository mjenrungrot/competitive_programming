...
# URL: https://judge.yosupo.jp/problem/enumerate_cliques
# Category: Graph

"""
Title: Enumerate Cliques

Link: https://judge.yosupo.jp/problem/enumerate_cliques
...
Find the sum of $\displaystyle \prod_{i \in C} x_i$ over all non-empty cliques $C$ of $G$, and print the sum modulo $998244353$ .
...
def solve():
    ...
    # TODO: implement solution for 'enumerate_cliques'
    pass
