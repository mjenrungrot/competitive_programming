...
def is_lying(speaker, assignment, target_value, target_self, target_negative, is_day):
    ...
    # X is not (divine/human/evil/lying).
        ...
        if speaker == "divine" or (speaker == "human" and is_day):
            ...
            if assignment == "divine" and (
                target_value == "evil" or target_value == "human"
            ):
                return True  # X is not (evil/human).
            elif assignment == "evil" and (
                target_value == "divine" or target_value == "human"
            ):
                return True  # X is not (divine/human).
            elif assignment == "human" and (
                target_value == "divine" or target_value == "evil"
            ):
                return True  # X is not (divine/evil).
            elif target_value == "lying":
                if assignment == "evil" or (assignment == "human" and not is_day):
                    return False
                else:
...
def run(N):
    ...
    for speaker in speakers:
        if len(passing_assignments[speaker]) == 1:
            n_facts += 1
            print("{} is {}.".format(speaker, list(passing_assignments[speaker])[0]))
