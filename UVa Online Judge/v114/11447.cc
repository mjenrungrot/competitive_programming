...
#  FileName:        11447.cc
#  Description:     UVa Online Judge - 11447
=============================================================================*/
#include <bits/stdc++.h>
...
void solve() {
    ...
    double total_amount = P.area() * W;

    double init_amount_percent, spent_amount, adding_amount;
    cin >> init_amount_percent >> spent_amount >> adding_amount;

    double init_amount = init_amount_percent / 100.0 * total_amount;

    if (spent_amount > init_amount) {
        cout << "Lack of water. ";
        spent_amount = init_amount;
    }

    double target_amount = init_amount - spent_amount + adding_amount;
    ...
    double ans = floor(target_amount / total_amount * 100.0);

    cout << "Final percentage: " << fixed << setprecision(0) << ans << "%"
         << endl;
}
