...
int main(){
    ...
    for(int _i=1; _i<=T; _i++){
        ...
        for(int j=1; j<=1000; j++){
            ...
            // printf("Jane:\n");
            // printf("\tFace-down=> ");
            // for(int k=0;k<(int)face_down_jane.size();k++) printf("%c", face_down_jane[k]);
            // printf("\tFace-up=> ");
            // for(int k=0;k<(int)face_up_jane.size();k++) printf("%c", face_up_jane[k]);
            // printf("\n");
            // printf("John:\n");
            // printf("\tFace-down=> ");
            // for(int k=0;k<(int)face_down_john.size();k++) printf("%c", face_down_john[k]);
            // printf("\tFace-up=> ");
            // for(int k=0;k<(int)face_up_john.size();k++) printf("%c", face_up_john[k]);
            // printf("\n");
