...
#  FileName:        12498.cpp
#  Description:     UVa Online Judge - 12498
=============================================================================*/
#include <algorithm>
#include <cstdio>
using namespace std;
...
int sum(int r, int x, int y) { return qs[r][y] - qs[r][x - 1]; }
...
int f(int col) {
    ...
    for (int i = 1; i <= R; i++) {
        ...
        if (sum(i, 1, col - 1) == col - 1 and sum(i, col + 1, C) == C - col)
            return 1e9;
