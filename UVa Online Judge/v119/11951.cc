...
#  FileName:        11951.cc
#  Description:     UVa Online Judge - 11951
=============================================================================*/
#include <bits/stdc++.h>
using namespace std;
...
int main() {
    ...
    while (T--) {
            ...
            for (int sc = 1; sc <= M; sc++) {
                ...
                for (int er = sr; er <= N; er++) {
                    ...
                    while (left < right) {
                        ...
                        bool check = qs[er][mid] - qs[er][sc - 1] -
                                         qs[sr - 1][mid] + qs[sr - 1][sc - 1] >
                                     K;
                        if (check)
                            right = mid;
                        else
                    ...
                    long long cost = qs[er][left] - qs[er][sc - 1] -
                                     qs[sr - 1][left] + qs[sr - 1][sc - 1];
        ...
        cout << "Case #" << ++n_case << ": " << best_area << " " << best_cost
             << endl;
    }
    return 0;
}